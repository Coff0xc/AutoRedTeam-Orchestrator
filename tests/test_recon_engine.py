...
from core.recon.base import Finding, ReconConfig, ReconResult, Severity
...
class TestSensitiveFileDetection:
    ...
    def test_check_sensitive_file_found(self):
        ...
        with patch("urllib.request.urlopen") as mock_urlopen:
            ...
            result = engine._check_sensitive_file("https://example.com/.git/config", ".git/config")
    ...
    def test_check_sensitive_file_not_found(self):
        ...
        with patch("urllib.request.urlopen") as mock_urlopen:
            ...
            result = engine._check_sensitive_file("https://example.com/.env", ".env")
