...
class TestSessionCreateTool:
    ...
    async def test_create_session_success(self):
        ...
        with patch("core.session.get_session_manager") as mock_get_mgr:
            ...
            result = await registered_tools["session_create"](
                target="https://example.com", config={"quick_mode": True}
            )
    ...
    async def test_create_session_default_config(self):
        ...
        with patch("core.session.get_session_manager") as mock_get_mgr:
            ...
            result = await registered_tools["session_create"](target="https://example.com")
...
class TestSessionStatusTool:
    ...
    async def test_session_status_found(self):
        ...
        with patch("core.session.get_session_manager") as mock_get_mgr:
            ...
            result = await registered_tools["session_status"](session_id="abc123def456")
    ...
    async def test_session_status_not_found(self):
        ...
        with patch("core.session.get_session_manager") as mock_get_mgr:
            ...
            result = await registered_tools["session_status"](session_id="nonexistent")
    ...
    async def test_session_status_exception(self):
        ...
        with patch("core.session.get_session_manager") as mock_get_mgr:
            ...
            result = await registered_tools["session_status"](session_id="abc123")
...
class TestSessionListTool:
    ...
    async def test_session_list_with_filter(self):
        ...
        with patch("core.session.get_session_manager") as mock_get_mgr:
            ...
            result = await registered_tools["session_list"](status="active", limit=5)
...
class TestSessionCompleteTool:
    ...
    async def test_complete_session_success(self):
        ...
        with patch("core.session.get_session_manager") as mock_get_mgr:
            ...
            result = await registered_tools["session_complete"](session_id="abc123def456")
    ...
    async def test_complete_session_not_found(self):
        ...
        with patch("core.session.get_session_manager") as mock_get_mgr:
            ...
            result = await registered_tools["session_complete"](session_id="nonexistent")
    ...
    async def test_complete_session_exception(self):
        ...
        with patch("core.session.get_session_manager") as mock_get_mgr:
            ...
            result = await registered_tools["session_complete"](session_id="abc123")
