...
FALLBACK_CREDENTIALS = {
    ...
    "Joomla": {
        ...
        "credentials": [("admin", "admin"), ("admin", "joomla"), ("admin", "123456")],
        "user_field": "username",
        "pass_field": "passwd",
    ...
    "Drupal": {
        ...
        "credentials": [("admin", "admin"), ("admin", "drupal"), ("admin", "123456")],
        "user_field": "name",
        "pass_field": "pass",
    ...
    "Typecho": {
        ...
        "credentials": [("admin", "admin"), ("admin", "typecho"), ("admin", "123456")],
        "user_field": "name",
        "pass_field": "password",
    ...
    "Discuz": {
        ...
        "credentials": [("admin", "admin"), ("admin", "discuz"), ("admin", "123456")],
        "user_field": "username",
        "pass_field": "password",
    ...
    "DedeCMS": {
        ...
        "credentials": [("admin", "admin"), ("admin", "dedecms"), ("admin", "123456")],
        "user_field": "userid",
        "pass_field": "pwd",
    ...
    "ThinkPHP": {
        ...
        "credentials": [("admin", "admin"), ("admin", "123456"), ("admin", "admin888")],
        "user_field": "username",
        "pass_field": "password",
    ...
    "Spring": {
        ...
        "credentials": [("admin", "admin"), ("user", "user"), ("spring", "spring")],
        "user_field": "username",
        "pass_field": "password",
    ...
    "Jenkins": {
        ...
        "credentials": [("admin", "admin"), ("jenkins", "jenkins"), ("admin", "password")],
    ...
    "GitLab": {
        ...
        "credentials": [("root", "5iveL!fe"), ("admin", "admin"), ("root", "root")],
...
class VulnerabilityPipeline:
    ...
    def _run_fingerprint(self) -> Dict[str, Any]:
        ...
        if self.manager:
            ...
            if cached:
                ...
                return {
                    "success": True,
                    "technology": cached,
                    "detected_count": len(cached.get("cms", []))
                    + len(cached.get("frameworks", [])),
                    "from_cache": True,
                }
        ...
        try:
            resp = self._requests.get(self.target, timeout=self.timeout, verify=self.verify_ssl)
            ...
            if self.manager:
                ...
                self.manager.monitor.end_execution(
                    exec_id, success=True, result_size=len(str(tech))
                )
    ...
    def _run_fingerprint_weak_password(self) -> Dict[str, Any]:
        ...
        if self.manager and exec_id:
            self.manager.monitor.end_execution(
                exec_id, success=True, result_size=len(results["weak_credentials"])
            )
    ...
    def _run_targeted_vuln_scan(self) -> Dict[str, Any]:
        ...
        if self.manager and exec_id:
            self.manager.monitor.end_execution(
                exec_id, success=True, result_size=len(results["vulnerabilities"])
            )
        ...
        if self.context.weak_credentials:
            ...
            for cred in self.context.weak_credentials:
                ...
                if cred["cms"] == "WordPress":
                    ...
                    path["next"] = ["Deploy malicious WAR file", "Execute commands via manager"]
    ...
    def _generate_summary(self) -> Dict[str, Any]:
        ...
        summary = {
            "target": self.target,
            "fingerprint_count": len(self.context.detected_cms)
            + len(self.context.detected_frameworks),
...
def fingerprint_weak_password_detect(
    url: str, cms_hint: Optional[str] = None, verify_ssl: bool = True, timeout: int = 10
) -> Dict[str, Any]:
    """基于指纹的弱口令检测（独立函数）
