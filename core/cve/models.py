...
class CVEEntry:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'CVEEntry':
        ...
        references = [Reference.from_dict(ref) if isinstance(ref, dict) else ref for ref in refs_data]
    ...
    def merge_with(self, other: 'CVEEntry') -> 'CVEEntry':
        ...
        return CVEEntry(
            ...
            modified_date=max(filter(None, [self.modified_date, other.modified_date]), default=None),
            references=merged_refs,
            has_poc=has_poc,
            poc_urls=poc_urls,
            exploit_available=exploit_available,
            source=f"{self.source},{other.source}" if other.source and other.source not in self.source else self.source,
            tags=tags,
        )
...
class PoCTemplate:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'PoCTemplate':
        ...
        return cls(
            ...
            stop_at_first_match=data.get('stop-at-first-match', data.get('stop_at_first_match', True)),
