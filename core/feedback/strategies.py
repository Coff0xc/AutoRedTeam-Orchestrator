...
PROXY_STRATEGIES = [
    AdjustmentStrategy(
        ...
        description='切换代理服务器',
        applicable_reasons=[FailureReason.IP_BLOCKED, FailureReason.RATE_LIMITED, FailureReason.WAF_BLOCKED],
        priority=10,
        params={'rotate': True}
    ),
    AdjustmentStrategy(
...
HEADER_STRATEGIES = [
    ...
    AdjustmentStrategy(
        ...
        priority=6,
        params={'content_types': ['application/json', 'application/x-www-form-urlencoded', 'multipart/form-data']}
    ),
    AdjustmentStrategy(
