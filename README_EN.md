...
+-----------------------------------------------------------------------------+
|  * 134 MCP Tools         * 14 YAML Payload Files  * 1980 Tests             |
...
- [Tool Matrix](#tool-matrix-134-mcp-tools)
...
AI Editor (Cursor / Windsurf / Kiro / Claude Desktop / Claude Code)
        ...
        v
mcp_stdio_server.py ---- FastMCP("AutoRedTeam")  [134 tools registered]
        |
...
| AI | 5 | `ai_handlers.py` | `smart_payload`, `ai_attack_chain`, `ai_redteam_run_scenario`, `ai_surface_scan_handlers` |
...
Once connected, all 134 tools are available to the AI editor. Simply describe your security testing task in natural language.
