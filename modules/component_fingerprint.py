...
FINGERPRINTS = {
    ...
    "qianxin": {"patterns": [r"qianxin", r"奇安信", r"天擎"], "payloads": [], "cves": []},
    "hillstone": {
    ...
    "gitlab_runner": {"patterns": [r"gitlab-runner"], "payloads": [], "cves": ["CVE-2022-2992"]},
}
                ...
                for ptype in payload_types:
                    if "sqli" in ptype.lower():
                        ...
                        recommendations["sqli"].extend(
                            PayloadLibrary.get_all("sqli", "detection")[:5]
                        )

                    elif "rce" in ptype.lower() or "cmd" in ptype.lower():
                        if "rce" not in recommendations:
                            recommendations["rce"] = []
                        recommendations["rce"].extend(
                            PayloadLibrary.get_all("rce", "command_injection")[:5]
                        )
