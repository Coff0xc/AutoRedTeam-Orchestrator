        ...
        try:
            ...
            if result.returncode == 0:
                try:
                    ...
                    return {"success": True, "mode": mode, "raw_output": result.stdout}
            else:
...
class KubectlEnumTool(BaseTool):
    ...
    def execute(self, params: Dict[str, Any], session_id: str = None) -> Dict[str, Any]:
        ...
        result = {"success": True, "namespace": namespace or "all", "resources": {}}
        ...
        try:
            ...
            if check.returncode != 0:
                return {"success": False, "error": "无法连接到Kubernetes集群"}

            resources_to_enum = (
                [resource_type]
                if resource_type != "all"
                else ["pods", "services", "secrets", "configmaps", "deployments"]
            )
