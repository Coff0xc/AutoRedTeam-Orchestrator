...
FORBIDDEN_PATTERNS = [
    (r"open\s*\(\s*['\"]\/dev\/tty", "Use sys.platform != 'win32' check before opening /dev/tty"),
    (r"open\s*\(\s*['\"]\/tmp\/", "Use tempfile.gettempdir() instead of /tmp/"),
    (r"open\s*\(\s*['\"]\/var\/log\/", "Use tempfile.gettempdir() or logging module"),
    (r"Path\s*\(\s*['\"]\/tmp\/", "Use Path(tempfile.gettempdir()) instead"),
]
